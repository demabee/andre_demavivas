...
const FloatingImageTablet = styled.div`
  ...
  z-index: -1;
  top: ${props => props.scrollPos > 906 ? '200' : '50'}px;
  transform: rotate(340deg);
  transition-duration: 3s;
`;

const Skills = ({ isTablet, scrollPos, ref }) => {
  return (
    <div className={`mt-10 ${classes.skills}`} ref={ref}>
      <div className="text-center mb-6">
        <h1 className="font-body xl:text-5xl xl:mx-0 mx-3 font-pokemon">Language I Speak</h1>
      </div>
